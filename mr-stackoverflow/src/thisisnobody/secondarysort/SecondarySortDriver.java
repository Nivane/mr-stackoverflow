...
//		job.setPartitionerClass(DateTemperaturePartitioner.class);
	...
	public static void main(String[] args) throws Exception {
		...
		// throw new IllegalArgumentException("SecondarySortDriver <input-dir>
		// <output-dir>");
		// }

		// String inputDir = args[0];
		// String outputDir = args[1];
		int returnStatus = submitJob(
				new String[] { "C:/Users/ZLP/Desktop/temperature.txt", "C:/Users/ZLP/Desktop/secondarysort" });
